...
template <typename Ta, typename Tb, typename To> void LSM6DS33::vector_cross(const vector<Ta> *a, const vector<Tb> *b, vector<To> *out)
{
...
template <typename Ta, typename Tb> float LSM6DS33::vector_dot(const vector<Ta> *a, const vector<Tb> *b)
{
